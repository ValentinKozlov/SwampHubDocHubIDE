...
- **_metamodel_/** - каталог с метамоделью, определяющей структуру описания архитектуры. Сейчас подключена дефолтная метамодель расположенная по адресу
- **arch_mts_b2b/** - каталог с фактическими документами архитектуры
  - **app/** - компоненты приложения
  - **dochub.yaml** - манифест артефактов архитектуры
  - **welcome.md** - вводная страница документации
